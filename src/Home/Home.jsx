...
import "./styles.scss";
import { db, timestamp } from "../firebse";
import {
  addDoc,
  collection,
  deleteDoc,
...
import { addCardAsync } from "../redux/reducers/listReducers";
...
export default function Home() {
  ...
  // redux add card function
  const addMoreCard = (title, listId) => {
    dispatch(addCardAsync({ title, listId }));
  };
    ...
    >
      <DragDropContext onDragEnd={onDragEnd}>
        <Droppable droppableId="app" type="list" direction="horizontal">
          {(provided) => (
            <div
              className="wrapper dark:bg-background-dark	" 
